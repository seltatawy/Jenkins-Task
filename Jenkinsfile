pipeline {
    ...
    stages {
        ...
        post {  
         ...
         failure {  
             mail bcc: '', body: "<b>Example-</b><br>Project: ${env.JOB_NAME} <br>Build Number: ${env.BUILD_NUMBER} <br> URL de build: ${env.BUILD_URL}", cc: '', charset: 'UTF-8', from: '', mimeType: 'text/html', replyTo: 'shaimatatawy@gmail.com', subject: "ERROR CI: Project name -> ${env.JOB_NAME}", to: "shaimatatawy@gmail.com";  
         }  
         unstable {  
